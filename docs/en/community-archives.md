...
**Repair** also checks the selected local community ZIPs. If an unapproved ZIP differs from the pinned hash, Repair downloads and verifies a replacement before swapping out the old file; a failed download leaves the original in place. It does not redownload matching packs or override a mismatch you explicitly approved. Allow enough free space for a second copy of a large pack during repair.
